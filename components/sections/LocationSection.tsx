...
const CONNECTIVITY = {
  'Commute': [
    ...
    { place: 'Kalyan Shil Road Highway', dist: '0 KM' },
    { place: 'Sagaon Metro Station', dist: '0 KM' },
    { place: 'Mothagaon–Mankoli Bridge', dist: '5.0 KM' },
    { place: 'Kalyan Station', dist: '4.0 KM' },
    { place: 'Mumbai International Airport', dist: '4.5 KM' },
    { place: 'Navi Mumbai International Airport', dist: '20 KM' },
  ],
  'Education': [
    { place: 'Eva World School', dist: '1 KM' },
    { place: 'Guardian School', dist: '1.0 KM' },
    { place: 'Euro School', dist: '2.0 KM' },
    { place: 'New Cambridge English School', dist: '500 M' },
    { place: 'Model School', dist: '2.0 KM' },
    { place: 'S.S. Jondhale College of Engineering', dist: '1.0 KM' },
    { place: 'Omkar International School', dist: '1.0 KM' },
    { place: 'Narayana International School', dist: '1.0 KM' },
  ],
  'Healthcare': [
    { place: 'Icon Hospital', dist: '1.0 KM' },
    { place: 'AIIMS Hospital', dist: '1.5 KM' },
    { place: 'R R Hospital', dist: '2.1 KM' },
    { place: 'Jupiter Hospital', dist: '1.0 KM' },
  ],
  'Retail': [
    { place: 'DMart', dist: '0.5 KM' },
    { place: 'Xperia Mall', dist: '2.0 KM' },
    { place: 'R Mall', dist: '1.5 KM' },
    { place: 'Metro Mall', dist: '2.0 KM' },
  ],
}
